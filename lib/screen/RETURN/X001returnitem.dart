...
class ReturnItem2 extends StatefulWidget {
...
class _ReturnItem2State extends State<ReturnItem2> {
                                ...
                                onTap: () async {
                                  ...
                                  else 
                                  {
                                    ...
                                    cocosheet.showsalesMoadlBottomsheet(
                                        ...
                                        double.parse(value.salesitemListdata2[0]
                                            ['rate1']),
                                        0.00,
                                        0.00,
                                        double.parse(
