                                          ...
                                          InkWell(
                                              onTap: () async {
                                                ...
                                                List<Map<String, dynamic>>
                                                    outst = await OrderAppDB
                                                        .instance
                                                        .getOutstandingg(value
                                                            .todaySalesList[
                                                                index]["Cus_id"]
                                                            .toString()
                                                            .trim());
                                                print(
                                                    "outstandng list-------$outst");
                                                // double outstandingValue = outst[0]['outstanding'] as double;
                                                print(
                                                    "outstandng value= ${outst[0]["outstanding"]}");
                                                List<Map<String, dynamic>>
